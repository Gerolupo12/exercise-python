...
if 2 < 5 and 1 > 2:
    print('hay una falsa esta no e mostrara')
    
if 1 < 0 or 1 > 0: # si una condicion evalua en true se ejecuta la instruccion
    print('una de las dos condiciones devolvio true')

if 1 < 0 or 1 < 0: # si ambas condicioens son falsas entonces no se ejecuta
    print('si ambas condiciones evaluan en falso no se ejecuta esto ')
